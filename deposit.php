<?php
    ...
    if(isset($_POST['register'])) {
        ...
        // Saldo van de client's bankrekening
        $sql_check = "SELECT * FROM clients WHERE id = '$client_id'";
        $query_check = $conn->query($sql_check);
        $balance = $query_check->fetch_assoc()['balance'];

        $sql = "INSERT INTO transactions (user_id, client_id, type,cent5, cent10, cent25, cent100, cent250, srd5, srd10, srd20, srd50, srd100, prev_balance, created_at) VALUES ('$user_id', '$client_id', '$type', '$cent5', '$cent10', '$cent25', '$cent100', '$cent250', '$srd5', '$srd10', '$srd20', '$srd50', '$srd100', '$balance', NOW())";
        if($conn->query($sql)) {
            ...
            */
            ...
            // Saldo verhogen met Storting bedrag
...
<body>
    ...
    <div class="container">
        ...
        <form id="form_deposit" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
